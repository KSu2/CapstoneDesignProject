...
#test with cv2, pool number means threads, more threads doesnt nessecaryily mean faster we gotta test and tune it
...
def process_frame(frame):
    ...
    ## Hyperparameter tuning for both branches of multithreading -> grid search -> start by testing in power of 2s?
    # Change 32
    names = []
    with Pool(32) as p:
